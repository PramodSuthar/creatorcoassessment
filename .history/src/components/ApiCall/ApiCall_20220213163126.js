...
const ApiCall = () => {
    ...
    useEffect(() => {
        ...
        axios({
            ...
            setBooks(prevBooks => {
                return [...new Set([...prevBooks, ...res.data.results.map(b => b.results)])]//returns a list of old books and new books and will only return unique values since we are using set 
            })
